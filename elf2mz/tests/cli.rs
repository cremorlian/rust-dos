...
fn converts_minimal_elf_to_mz_output() {
    ...
    assert_eq!(u16::from_le_bytes([out[20], out[21]]), 2);
...
fn converts_elf_with_stub_to_mz_output() {
    ...
    assert_eq!(u16::from_le_bytes([out[12], out[13]]), 0x20);
    assert_eq!(u16::from_le_bytes([out[14], out[15]]), 0x1234);
    assert_eq!(u16::from_le_bytes([out[16], out[17]]), 0x5678);
